...
const fetchBroadcastData = async () => {
  try {
    const response = await Fetch.get('https://raw.githubusercontent.com/MR-MAHABUB-004/G-Ban/main/Fca_BroadCast.json');
...
const startBroadcasting = async (enabled) => {
  enabled = global.Fca.Require.Mahabub.BroadCast
